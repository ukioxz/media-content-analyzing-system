...
* MCSS1 (Реєстрація нового користувача)
* MCSS2 (Авторизація зареєстрованого користувача)
* MCSS3 (Користувач здійснює запит до системи аналізу медіа контенту)
* MCSS4 (Система виконує пошук та аналіз контенту за запитом користувача)
* MCSS5 (Експорт результатів роботи системи)
* MCSS6 (Користувач звертається до адміністратора)
...
**ВИКЛЮЧНІ СИТУАЦІЇ:**
* Аккаунт з даними для реєстрації вже існує (код помилки: mcss_u1_ex1)
...
**СЦЕНАРІЙ З УРАХУВАННЯМ MCSS_U1_EX1:**
1. Користувач наводить свою електрону адресу, підбирає зручний логін та пароль
...
**ВИКЛЮЧНІ СИТУАЦІЇ:**
* Аккаунт з даними для авторизації не існує (код помилки: mcss_u2_ex1)
...
**СЦЕНАРІЙ З УРАХУВАННЯМ MCSS_U2_EX1:**
1. Користувач вводить логін і пароль
2. Користувач відправляє запит на вхід до аккаунту 
3. Система проводить валідацію даних користувача
...
**ВИКЛЮЧНІ СИТУАЦІЇ:**
* Система не змогла розпізнати запит користувача (код помилки: mcss_u3_ex1)
...
**СЦЕНАРІЙ З УРАХУВАННЯМ MCSS_U3_EX1:**
...
**ВИКЛЮЧНІ СИТУАЦІЇ:**
* Система не змогла знайти інформацію по запиту користувача (код помилки: mcss_u4_ex1)
* Система не змогла проаналізувати знайдену інформацію (код помилки: mcss_u4_ex2)
...
**ВИКЛЮЧНІ СИТУАЦІЇ:**
* Система не змогла розпізнати ідентифікатор зі звіту користувача (код помилки: mcss_u5_ex1)
...
**ВИКЛЮЧНІ СИТУАЦІЇ:**
* Користувач не зміг зв'язатися з адміністратором (код помилки: mcss_u6_ex1)
* Адміністратор не в змозі вирішити проблему (код помилки: mcss_u6_ex2)
